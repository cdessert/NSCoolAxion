...
c**********************************************************************
      ...
      subroutine nubrem_nucl(i,t,time,qbrem_nucl,qasync)
...
c      print *,fmG
c      print *,K2GeV
c      print *,'kfm(i) = : ',kfm(i) * fmG
c      print *,'t(i) = : ',time,t * K2GeV
c      print *,'kfe(i) = : ',kfe(i)

c      qasync=8.67d-3 * GeVtoem * gaee**2    *
c     1      (kfe(i) * fmG)**(-2.d0 / 3.d0)  * 
c     2      (t * K2GeV)**(13.d0 / 3.d0)     * 
c     3      (efac*Bfie)**(2.d0 / 3.d0)

c      print *,'qasync e: ',qasync

      if (kfm(i) > 0) then
       qasync=8.67d-3 * GeVtoem * gamm**2    *
     1        (kfm(i) * fmG)**(-2.d0 / 3.d0)  * 
     2        (t * K2GeV)**(13.d0 / 3.d0)     * 
     3        (efac*Bfie)**(2.d0 / 3.d0)
      else
       qasync=0d0
      end if
      qasync = 0d0

c      print *,'qasync mu: ',qasync
